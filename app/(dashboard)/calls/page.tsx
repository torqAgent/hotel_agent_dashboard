import { getRoomWithBookings } from '@/server/db/queries'
    ...
    <div>
      <div className="mb-5">
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          All rooms with availability and booking history
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {rooms.map((r) => {
          const isAvailable = r.availability === true
          ...
          return (
            ...
            >
              ...
              <div className="text-xs text-gray-500 mb-2">
                {r.bookings.length} booking
                {r.bookings.length !== 1 ? 's' : ''}
              </div>

              {!isAvailable && r.bookedBy && (
                <div className="mb-3 text-xs text-red-300">
                  Current guest: {r.bookedBy}
                </div>
              )}
